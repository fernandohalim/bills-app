          ...
          <div className="fixed inset-0 bg-stone-900/40 backdrop-blur-md z-50 flex items-end sm:items-center justify-center p-0 sm:p-4 animate-in fade-in duration-300">
            <div className="bg-[#fdfbf7] w-full max-w-md rounded-t-[2.5rem] sm:rounded-[2.5rem] shadow-2xl flex flex-col animate-in slide-in-from-bottom-full sm:zoom-in-95 duration-500 overflow-hidden relative pb-8 sm:pb-0">
              ...
              <div className="p-8 pt-12 flex flex-col items-center text-center relative z-10">
                ...
                {/* links grid - playful & tactile (no crazy animations) */}
                <div className="w-full flex flex-col gap-3">
                  {/* 🔥 1. Hero Changelog Button (Violet) 🔥 */}
                  <button
                  ...
                  >
                    ...
                    <svg
                      className="w-4 h-4 text-stone-300 group-hover:text-emerald-500 transition-all duration-300 group-hover:translate-x-1"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                  ...
                  >
                    ...
                    <svg
                      className="w-4 h-4 text-stone-300 group-hover:text-blue-500 transition-all duration-300 group-hover:translate-x-1"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                  ...
                  >
                    ...
                    <svg
                      className="w-4 h-4 text-stone-300 group-hover:text-stone-600 transition-all duration-300 group-hover:translate-x-1"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                  ...
                  >
                    ...
                    <svg
                      className="w-4 h-4 text-stone-300 group-hover:text-amber-500 transition-all duration-300 group-hover:translate-x-1"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
